...
As a reference, we provide the results of Our model (ESRNet) below:
- Average PSNR on DIV2K_LSDIR_valid: 26.91 dB
- Number of parameters: 0.137 M
- Runtime: 18.66 ms (on Valid Dataset)
- FLOPs on an LR image of size 256×256: 8.93 G
